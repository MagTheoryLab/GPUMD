...
For ``spin_mode 3``, the current radial construction uses exactly nine basis
...
is not serialized in ``nep4_spin3``. This keyword must be set explicitly for
Spin3 because the default is not a valid Spin3 setting.
